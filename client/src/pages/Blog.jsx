...
fetchComments()
  ...
  return data ? (
    <div className='relative'>
      <img src={data.gradientBackground} alt="" className='absolute -top-50 -z-1 opacity-50'/>
      <Navbar/>
      <div className='text-center mt-20 text-gray-600'> 
        ...
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border-primary/35 bg-primary/5 font-medium text-primary'>{data.author?.name || 'Anonymous'}</p>
      </div>

<div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
<img src={data.image} alt="" className='rounded-3xl mb-5'/>

<div className='custom-text max-w-3xl mx-auto' dangerouslySetInnerHTML={{__html: data.description}}></div>
...
<div className='flex items-center gap-2 mb-2'>
  <img src={data.user_icon} alt="" className='w-6' />
